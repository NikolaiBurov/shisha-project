   ...
   <div class="hero">
      <div class="tp-banner-container">
         <div class="tp-banner">
            <ul>
               <!-- SLIDE 1 -->
               <li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-thumb="/img/backgrounds/bg.jpg" data-delay="10000" data-saveperformance="on" data-title="Най-изгоден автомобил">
                  <img src="/img/backgrounds/1111123123123.jpg" alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                  ...
                  <div class="tp-caption sft"
                     ...
                     <h2 class="home-heading op-1">Най-изгоден автомобил</h2>
                  </div>
                  <!-- Home Subheading -->
                  <div class="tp-caption home-subheading sft "
                                        ...
                                        data-endspeed="300"
                                        style="z-index: 4; max-width: auto; max-height: auto; white-space:normal;">
                     <div class="op-1">Проверете вашата 46-ца в нашият сайт</div>
                  </div>
                  <!-- Home Button -->
                  <div class="tp-caption home-button sft fadeout"
                                        ...
                                        style="z-index: 4; max-width: auto; max-height: auto; white-space:normal;">
                     <div class="op-1">
                        <a href="{{$url}}" class="btn btn-primary btn-scroll">
                          Проверка
                        </a>
                     </div>
                  </div>
         ...
         <div class="row">
            <div class="col-md-3 col-sm-3 team-member">
               ...
               <div class="member-info wow fadeInUp">
                  <h4>Svetlin Nikolov</h4>
                  <h5 class="highlight">.NET Dev</h5>
                  <p>ASP,C#,MYSQL</p>
               </div>
            </div>
            <div class="col-md-3 col-sm-3 team-member">
               ...
               <div class="member-info wow fadeInUp">
                  <h4>Nikolai Burov</h4>
                  <h5 class="highlight">PHP Dev</h5>
                  <p>Drupal,Laravel,Custom MVC</p>
               </div>
            </div>
